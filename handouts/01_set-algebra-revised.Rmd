---
title: 'Probability Handout 1: Introduction to the Algebra of Sets'
header-includes: \usepackage{subcaption,tikz} \usetikzlibrary{shapes,backgrounds}
...
Collection of **elements** or **numbers** or **outcomes** or **events**.  
...
A set having no elements is called the null or empty set, denoted $\o$.  
...
$\hspace{2.25 in}$ (read "$\Rightarrow$" as "implies").   
$\vspace{1 mm}$  
...
\draw (-2,-1.5) rectangle (3.5,1.5);
\draw (.75,-1.3) node {$A \cup B$};
\fill[gray] (-.5,0) circle (1cm);
\fill[gray] (2,0) circle (1cm);
\draw (-.5,0) circle (1cm);
\draw (2,0) circle (1cm);
\draw (3.1,1.1) node {$U$};
\draw (-.5,0) node {$A$};
...
_Theorem 1-2._$\hspace{10 mm} A \cup B = B \cup A$. $\hfill { \textup{[Commutative law for unions].}}$    
$\vspace{1 mm}$  

_Theorem 1-3._$\hspace{10 mm} A\cup ( B \cup C ) = (A \cup B) \cup C = A \cup B \cup C$. $\hfill { \textup{[Associative law for unions].}}$     
$\vspace{1 mm}$  

_Theorem 1-4._ $\hspace{10 mm} A \cap B = B \cap A$. $\hfill { \textup{[Commutative law for intersections].}}$   
$\vspace{1 mm}$  

_Theorem 1-5._$\hspace{10 mm} A\cap ( B \cap C ) = (A \cap B) \cap C = A \cap B \cap C$. $\hfill { \textup{[Associative law for intersections].}}$  
$\vspace{1 mm}$  

_Theorem 1-6._ $\hspace{10 mm} A \cap(B \cup C) = (A \cap B) \cup (A \cap C)$.$\hfill { \textup{[First distributive law].  }}$  
$\vspace{1 mm}$  

_Theorem 1-7._ $\hspace{10 mm} A \cup(B \cap C) = (A \cup B) \cap (A \cup C)$. $\hfill { \textup{[Second distributive law]. }}$   

$\hspace{32 mm}$ [In 1-6 and 1-7 "$\cup$" and "$\cap$" are exchanged - "Principle of Duality"]  
$\vspace{1 mm}$  
...
_Theorem 1-12a._ $\hspace{10 mm} {(A \cup B)}' = {A}' \cap {B}'$. $\hfill { \textup{[DeMorgan's First Law].}}$  
$\vspace{1 mm}$  

_Theorem 1-12b._$\hspace{10 mm} {(A \cap B)}' = {A}' \cup {B}'$. $\hfill { \textup{[DeMorgan's Second Law].}}$    
$\vspace{1 mm}$  
